...
Description: Downloads the sarcasm data from Kaggle.
"""
import os
import kaggle
import zipfile
...
logs_path = log_dir / 'downloading.log'
...
class DatasetsLoader:
    ...
    def download_data(self) -> None:
        ...
        Logger.log_info("Downloading the datasets " +
                        f"{self.data_name} to {self.output_dir}")
        kaggle.api.dataset_download_files(self.data_name,
                                          path=self.output_dir, unzip=False)
